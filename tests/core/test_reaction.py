...
class TestReaction:
    ...
    def test_get_atom_bond_distance_to_reaction_center(self):
        ...
        combined union graph (the bond index is assigned to mimic combine_graphs()
        function)
        ...
        atom_hop_dist = rxn.atom_distance_to_reaction_center
        assert atom_hop_dist == [0, 2, 0, 1, 0, 2]

        bond_hop_dist = rxn.bond_distance_to_reaction_center
        assert bond_hop_dist == [2, 3, 1, 2, 0, 0]
