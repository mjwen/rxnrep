...
from rxnrep.data.electrolyte import ElectrolyteDatasetNoAddedBond
...
def load_dataset(args):
    ...
    trainset = ElectrolyteDatasetNoAddedBond(
    ...
    valset = ElectrolyteDatasetNoAddedBond(
    ...
    testset = ElectrolyteDatasetNoAddedBond(
