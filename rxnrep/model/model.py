...
class ReactionRepresentation2(ReactionRepresentation):
    """
    The same as ReactionRepresentation except that:
    ...
    def __init__(
        ...
        super(ReactionRepresentation2, self).__init__(
            in_feats,
            embedding_size,
            # encoder
            molecule_conv_layer_sizes,
