...
class GATConv(nn.Module):
    ...
    def forward(
        ...
        g.edges["bond"].data.update({"el": el})
        ...
        g.edges["bond"].data["ft_alpha"] = h_add_e * alpha

        # message passing
        g.update_all(fn.copy_e("ft_alpha", "m"), fn.sum("m", "ft_alpha"), etype="bond")
        h = g.nodes["atom"].data["ft_alpha"]  # (N, heads, out_size)
